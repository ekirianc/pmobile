...
class ContactAdapter (val phoneItemList: List<com.higerphi.praktek.PhoneData>, val clickListener: (com.higerphi.praktek.PhoneData) -> Unit) :
    RecyclerView.Adapter<RecyclerView.ViewHolder>()
{
    ...
    class PartViewHolder (itemView: View) : RecyclerView.ViewHolder(itemView){
        fun bind(phone: com.higerphi.praktek.PhoneData, clickListener: (com.higerphi.praktek.PhoneData) -> Unit){
